...
func TestAdd(t *testing.T) {
	...
	t.Run("update key exist", func(t *testing.T) {
		key := "test"
		word := "this is a test"
		newWord := "hello world"
		...
		dictionary.Update(key, newWord)

		assertDefinition(t, dictionary, key, newWord)
	})

	t.Run("update key not exist", func(t *testing.T) {
	...
	t.Run("delete key exist", func(t *testing.T) {
		key := "test"
		word := "this is just a test"
		dictionary := Dictionary{key: word}
